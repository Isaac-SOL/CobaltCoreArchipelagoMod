...
{
    public static void Postfix(Card __instance, Vec? posOverride, bool isInCombatHand)
    {
        ...
        Rect rect = (__instance.GetScreenRect()
                     + pos
        ...
        Draw.Rect(rect.x + 1, rect.y + 1, rect.w - 3, rect.h - (__instance.isForeground ? 2 : 0),
                  color: new Color(0.0, 0.0, 0.0, 0.65));
    }
}